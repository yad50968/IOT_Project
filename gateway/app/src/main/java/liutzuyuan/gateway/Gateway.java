...
class Gateway {
    ...
    private static Gateway sInstance;
    ...
    static synchronized Gateway getInstance(Context context) {

        if (sInstance == null) {
            sInstance = new Gateway(context.getApplicationContext());
        }
        return sInstance;
    }
            ...
            public void onRequest(AsyncHttpServerRequest request, AsyncHttpServerResponse response) {
                ...
                try {
                    ...
                    if(dbh.addUserData(newUser)) {
                        ...
                        response.send(res);
                        postRegisterUserToServer(ID, Ku, serverURL);
                    } else {
            ...
            public void onRequest(AsyncHttpServerRequest request, AsyncHttpServerResponse response) {
                ...
                if (CB1.equals(CB3)) {
                    ...
                    try {
                        ...
                        response.send(res);
                        postTokenToServer(ID, token, serverURL);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                } else {
    ...
    private void postRegisterUserToServer(final String username, final String Ku, final String url) {
    ...
    private void postTokenToServer(final String username, final String token, final String url) {
